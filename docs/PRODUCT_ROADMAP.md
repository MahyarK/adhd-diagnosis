...
5. Add an appointment prep page with scripts and a checklist.
6. Add a task breakdown page with brain dump and microsteps.
7. Add follow-up reminders with downloadable `.ics` files.
8. Add a weekly reset planner for recovering from falling behind.
9. Add a symptom/context tracker for clinician-ready notes.
10. Add a starter resource library for trustworthy low-friction next steps.
...
21. Save goals/plans/routines/weekly reset/communication repair/energy crash rescue/decision rescue/focus sprint/home reset/money-admin rescue/appointment prep/care notes/support requests/provider shortlist/access plan/task breakdown/reminders/tracker to local storage.
