...
7. Add a medication refill rescue tool for running low, being out, pharmacy blocks, cost/stock confusion, and safe next contact.
8. Add a food rescue tool for low-energy, low-appetite, low-money, and forgot-to-eat moments.
9. Add a sleep wind-down tool for bedtime procrastination, racing thoughts, screen boundaries, and tomorrow launch pads.
10. Add a motivation menu for free/low-cost rewards, safe stimulation, and boring-task activation.
11. Add a wins/evidence log for tiny progress, supports that worked, and patterns worth repeating.
12. Add an accountability check-in for body doubling, proof of progress, and missed-check-in recovery.
13. Add an appointment prep page with scripts and a checklist.
14. Add a task breakdown page with brain dump and microsteps.
15. Add follow-up reminders with downloadable `.ics` files.
16. Add a weekly reset planner for recovering from falling behind.
17. Add a symptom/context tracker for clinician-ready notes.
18. Add a starter resource library for trustworthy low-friction next steps.
19. Add a provider shortlist for possible clinicians, clinics, and support offices.
...
- A user can create a medication refill rescue card and print/download it.
...
- A user can save a wins/evidence card that makes tiny progress easier to remember and repeat.
