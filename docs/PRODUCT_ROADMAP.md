...
6. Add an appointment prep page with scripts and a checklist.
7. Add a task breakdown page with brain dump and microsteps.
8. Add follow-up reminders with downloadable `.ics` files.
9. Add a weekly reset planner for recovering from falling behind.
10. Add a symptom/context tracker for clinician-ready notes.
11. Add a starter resource library for trustworthy low-friction next steps.
12. Add a provider shortlist for possible clinicians, clinics, and support offices.
13. Add a low-cost access plan for care barriers.
14. Add care discussion notes and a support request builder.
15. Add a home reset tool for cleaning and clutter overwhelm.
16. Add a money/admin rescue tool for bills, forms, messages, appointments, insurance/cost questions, and overdue tasks.
17. Add a morning/evening/leaving-home routine builder.
18. Add a communication repair tool for late replies, conflict, boundaries, and support asks.
19. Add an energy crash rescue tool for burnout, overwhelm, and low-capacity days.
20. Add a decision rescue tool for choosing one good-enough priority and parking the rest.
21. Add a focus sprint tool for starting work with a timer, body-double support, distraction parking, and a reward.
22. Add an emotional reset tool for shame spirals, rejection sensitivity, guilt, conflict, and overwhelm.
23. Add a transition rescue tool for waiting mode, leaving home, switching tasks, bedtime, and frozen-before-start moments.
24. Save goals/plans/time blocks/routines/weekly reset/communication repair/energy crash rescue/decision rescue/focus sprint/emotional reset/transition rescue/home reset/money-admin rescue/appointment prep/care notes/support requests/provider shortlist/access plan/task breakdown/reminders/tracker to local storage.
